...
//	センサ名はres[0]に、温度はres[1]、湿度はres[2]に格納される
	...
	g.fillStyle="lightGray";
	g.fillRect( 80,250,140,50);	// センサ名の枠
	g.fillRect(230,250,180,50);	// 温度の枠
	g.fillRect(420,250,160,50);	// 湿度の枠
	g.font="40px 'Arial'";
	g.fillText("温度",80,235);
	g.fillText("co2濃度",230,235);
	g.fillText("光量",450,235);
	g.fillStyle="Red";
	g.fillText(res[0]+"℃",90,290);
	g.fillText(res[1]+"ppm",235,290);
	g.fillText(res[2]+"lm",425,290);
}
////////////////////////////////////////////////////////////////////////
