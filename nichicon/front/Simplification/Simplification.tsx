...
import { ports,AssemblyNotCode,WindingMachine,AllAuthorityList,Weight_BZI,Assembly_init_BZI,re2 } from "../Data/Data"
          ...
          <table border={1} key={"table"}>
            <tbody key={"body"}>
              ...
              <tr key={"組立形式入力要素入力"}>
                ...
                {state === 0?<TD>{watch(`device_diameter`)}</TD>:<td><TextField {...register(`device_diameter`)} type="number" className='df'/></td>}
