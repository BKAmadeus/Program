...
fig,ax = plt.subplots()
c = ax.pcolormesh(Y, X, RSSI, cmap='RdBu',alpha=0.6,vmin=-130, vmax=-85)
fig.colorbar(c, ax=ax)
ax.plot(Y[uy,ux],X[uy,ux],marker="*",markersize=10,c='red')
...
fig, ax = plt.subplots()
ax.plot(X[uy,ux],Y[uy,ux],marker="*",markersize=10,c='red')
c = ax.pcolormesh(Y, X, RSSI, cmap='RdBu',alpha=0.6)
fig.colorbar(c, ax=ax)
"""
